<?php
    ...
    $silinecek = mysqli_real_escape_string($baglanti, $_GET["EsKayNo"]);
    $sorgu = "DELETE FROM ESER WHERE EsKayNo = '$silinecek'";

    if (mysqli_query($baglanti, $sorgu)) {
        $islemSonuc = "ESER SİLİNDİ";
    } else {
        $islemSonuc = "Eser silinirken bir hata oluştu: " . mysqli_error($baglanti);
    }
