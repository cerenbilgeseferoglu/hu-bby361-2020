...
$silinecek = mysqli_real_escape_string($baglanti, $_GET["YayineviNo"]);
    $sorgu = "DELETE FROM yayin WHERE YayineviNo = '$silinecek'";

    if (mysqli_query($baglanti, $sorgu)) {
        $islemSonuc = "YAYIN BİLGİSİ SİLİNDİ";
    } else {
        $islemSonuc = "Yayın bilgisi silinirken bir hata oluştu.: " . mysqli_error($baglanti);
    }
