...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 13 Oca 2021, 11:37:30
...
(5, '2021-01-10 20:05:02', 'http://www.biology.hacettepe.edu.tr/tr/ekoloji_anabilim_dali-5', 'Ayşe', 'Boşgelmez'),
(6, '2021-01-03 20:05:06', 'https://www.arkitera.com/author/beyhan-islam/', 'Beyhan ', 'İslam'),
(7, '2021-01-06 20:05:14', 'https://www.biyologlar.com/prof-dr-m-nihat-sisli-kimdir-', 'M. Nihat', 'Şişli'),
(8, '2021-01-05 20:05:17', 'https://scholar.google.com.tr/citations?user=j3qWKsYAAAAJ&hl=tr', 'Tuncay', 'Önder'),
(9, '2021-01-05 20:05:26', 'https://www.dr.com.tr/Yazar/ahmet-kocatas/s=40348', 'Ahmet ', 'Kocataş'),
...
--
ALTER TABLE `yazar`
  MODIFY `YazNo` smallint(11) NOT NULL AUTO_INCREMENT COMMENT 'Yazara Ait Numara Bilgisi', AUTO_INCREMENT=115;
--
...
(1, '2020-12-12 19:08:43', 'Ceren Bilge SEFEROĞLU', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.'),
(2, '2020-12-12 19:08:43', 'Beste SEFEROĞLU', 'It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using \'Content here, content here\', making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).'),
(5, '2020-12-12 20:33:34', 'orhan pamuk', 'yeni kitap hazırlıklarımız var'),
(6, '2020-12-12 20:37:34', 'Ahmet Ümit', 'yeni bir polisiye üzerinde çalışıyorum'),
(7, '2020-12-14 16:28:45', '', '');
...
--
ALTER TABLE `mesajlar`
  MODIFY `mesajNo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
('root', '[{\"db\":\"cerenbilgeseferoglu_01\",\"table\":\"yazar\"},{\"db\":\"cerenbilgeseferoglu_01\",\"table\":\"yayin\"},{\"db\":\"cerenbilgeseferoglu_01\",\"table\":\"eser\"},{\"db\":\"cerenbilgeseferoglu_01\",\"table\":\"liste\"},{\"db\":\"yayin bilgisi\",\"table\":\"yazar bilgisi\"},{\"db\":\"yayin bilgisi\",\"table\":\"yayin bilgisi\"},{\"db\":\"yayin bilgisi\",\"table\":\"eser bilgisi\"},{\"db\":\"mesaj\",\"table\":\"mesajlar\"},{\"db\":\"cerenbilgeseferoglu_01\",\"table\":\"eserbilgisi\"},{\"db\":\"cerenbilgeseferoglu_01\",\"table\":\"yayinbilgisi\"}]');
...
('root', 'yayin bilgisi', 'yayin bilgisi', '[]', '2020-11-18 09:53:03');
...
('root', '2021-01-13 10:34:32', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"tr\"}');
...
USE `test`;
--
-- Veritabanı: `yayin bilgisi`
--
CREATE DATABASE IF NOT EXISTS `yayin bilgisi` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `yayin bilgisi`;
...
INSERT INTO `yayin bilgisi` (`YayineviAd`, `YayinTar`, `YayinYer`, `YayineviNo`) VALUES
...
INSERT INTO `yazar bilgisi` (`YazAdi`, `YazSoyad`, `YazNo`, `YazUrl`) VALUES
